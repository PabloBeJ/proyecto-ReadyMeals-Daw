        ...
        <form class="col m12 l6" enctype="multipart/form-data"  method="POST" action="{{ url("admin/usuarios/".$accion) }}">
            ...
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <label for="nombre">Nombreaass</label>
                </div>
                <div class="input-field col s12">
...
document.querySelector("form").addEventListener("submit", function(event) {
    event.preventDefault(); // Temporarily stop the form to inspect it
    console.log("Form method:", this.method); // Should be POST
    console.log("Form action:", this.action); // Check if URL is correct
    ...
    this.submit(); // Continue submission
});
</script>
