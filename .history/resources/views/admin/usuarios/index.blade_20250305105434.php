                ...
                <div class="card horizontal  sticky-action admin">
                    <div class="card-stacked">
                       ...
                       <div class="card-reveal">
                        ...
                        <p style="color:#000; position: relative; z-index: 10;">
                            ¿Está seguro de que quiere borrar este usuario<strong>{{ $row->usuario }}</strong>?<br>
                            Esta acción no se puede deshacer.
                        </p>
                        <a href="{{ url("admin/usuario/borrar/".$row->id) }}" title="Borrar">
                        <button class="btn waves-effect waves-light" type="button">Borrar
                            <i class="material-icons right">delete</i>
                        </button>
                    </a>
