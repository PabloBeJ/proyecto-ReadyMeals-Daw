...
@section('content')
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="input-field col s12 center-align">
                        ...
                        <!-- Botón de borrar solo si el usuario tiene ID -->
                        @if($row->id)
                            <!-- Trigger Modal to Confirm Deletion -->
                            <a href="#delete-modal" class="modal-trigger btn red">
                                Borrar
    ...
    <div id="delete-modal" class="modal">
        <div class="modal-content">
            ...
            <form action="{{ url('admin/usuarios/borrar/' . $row->id) }}" method="GET">
                ...
                <div class="input-field col s12 hide">
                    <input id="email" type="text" name="email" value="{{ $row->email}}">
                    <label for="email">Usuario3</label>
                </div>
                <div class="modal-footer">
                    <a href="#!" class="modal-close btn waves-effect waves-light">Cancelar</a>
                    <button type="submit" class="btn waves-effect waves-light red">Confirmar</button>
                </div>
            </form>
        </div>
    </div>
